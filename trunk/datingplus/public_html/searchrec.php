...
if ( $_POST['searchtype'] == 'simple' ) {
	...
	if ( $_POST['txtsearch'] == 'AA' ) {
		...
		$sql .= " WHERE status in ('Active','".$lang['status_enum']['active']."') and " . $_POST['searchby'] . "<>'" . $_POST['txtsearch'] . "' AND id > 0 ";
	...
	$sql = 'SELECT * FROM ' . USER_TABLE . " WHERE status in ('Active','".$lang['status_enum']['active']."') AND id > 0 and ";
