...
$_SESSION['lookfrom'] = $lookcountrycode = ($_SESSION['lookfrom']!= '') ? $_SESSION['lookfrom'] : $config['default_country'];
/*
...
$_SESSION['lookagestart'] = ($_SESSION['txtlookagestart'] > 0)? $_SESSION['txtlookagestart']:'18';

$_SESSION['lookageend'] = ($_SESSION['txtlookageend'] > 0)? $_SESSION['txtlookageend']:'99';

$t->assign ( 'signup_error', $lang['errormsgs'][$_GET['errid']] );
