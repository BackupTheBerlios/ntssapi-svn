...
if ( $searchtype == 'simple' ) {
	if ( $searchby == 'username' ) {
		...
		$querystring = array('searchtype'=>'simple','searchby'=>$searchby,'txtsearch'=>$searchtxt);
			...
			" as user, " . USER_PREFERENCE_TABLE . " as pref where user.id=pref.userid  AND status in ('Active','".$lang['status_enum']['active']."') AND user.id > 0 AND user.id<>'" . $_SESSION['UserId'] ."'";
			$keyval = '';
