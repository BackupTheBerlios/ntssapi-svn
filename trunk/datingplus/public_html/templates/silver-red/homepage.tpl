								...
								<td width="100%" align="center">
									<br />
										<table width="571" border="0" cellpadding="0" cellspacing="0" >
											...
											<tr>
												<td width="397" valign="middle"  height="37"  align="center">
													<span class="text_head1">{$lang.dont_stay_alone}</span>&nbsp;
													<a href="signup.php" class="text_head1">{$lang.join_now_for_free}</a>
												</td>
											</tr>
										</table>
								</td>
			...
			<table width="571" border="0" cellpadding="0" cellspacing="0" >
				...
				<tr>
					...
					{if $smarty.session.expired == '1'}
						<table width="571" border="0" cellpadding="{$config.cellpadding}"  cellspacing="{$config.cellspacing}" height="23">
							<tr>
								<td width="6">&nbsp;</td>
								<td width="494">
			...
			<table width="571" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td class="module_detail" width="571">
						...
						<table  width="571" cellpadding="0" cellspacing="5" border="0">
              ...
              {/if}
								<td >
									{if $user.allow_viewonline eq '1'}
										<a href="javascript:popUpScrollWindow('showprofile.php?id={$user.id}','top',650,600)">
									{/if}
									{$user.username}
									{if $user.allow_viewonline eq '1'}
										</a>
