...
<table width="573" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="module_head" width="496">{$lang.manage_article}</td>
	</tr>
</table>
<br />
<center>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="module_head" width="526">
						{$lang.total_articles}&nbsp; {$total_recs}
					</td>
      ...
      <form action="" name="frm" method="post" onsubmit="javascript: return confdel(this,'{$lang.admin_js_error_msgs[1]}');">
			<table width="540" border="0" cellspacing="0" cellpadding="0" align="center">
				<tr>
					<td>
						<table width="540" cellspacing="{$config.cellspacing}" cellpadding="{$config.cellpadding}" border="0">
							<tr><td colspan="3"><a href="articleins.php">{$lang.insert_article}</a></td>
							...
							<tr class="table_head">
							  	<th nowrap="nowrap">{$lang.col_head_srno}</th>
                  				<th nowrap="nowrap">
							  	<a href="?sort={$lang.col_head_id}&amp;type={$sort_type}">{$lang.col_head_id}</a>
							  	</th>
                  				<th nowrap="nowrap"><a href="?sort={$lang.col_head_sendtime}&amp;type={$sort_type}">{$lang.col_head_sendtime}</a></th>
                  				<th nowrap="nowrap"><a href="?sort={$lang.article_title}&amp;type={$sort_type}&amp;offset={$smarty.get.offset}">{$lang.article_title}</a></th>
                ...
                <td nowrap="nowrap"><a href="?edit={$item.articleid}"><img src="images/button_edit.png" border="0" alt="" /></a></td>
			  					<td><a href="#" onclick="javascript:confirmDelete({$item.articleid},'{$lang.admin_js__delete_error_msgs[7]}')"><img src="images/button_drop.png" alt="Delete" border="0" /></a></td>
							</tr>
						{/foreach}
						</table>
					</td>
