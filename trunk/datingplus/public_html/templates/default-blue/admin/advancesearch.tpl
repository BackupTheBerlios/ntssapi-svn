...
<table id="tbl" class="table"  width="95%" border="0">
	<tbody>
		<tr>
			<td colspan="2">
		...
		{ else }
				<input name="txtstates" type="text" size="30" maxlength="100" />
		{ /if }
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>&nbsp;</td>
			<td><input type="hidden" name="searchtype" value="advance" /><input type="submit" class="formbutton" value="{$lang.search}" /></td>
		</tr>
	</tbody>
</table>
  </form>
