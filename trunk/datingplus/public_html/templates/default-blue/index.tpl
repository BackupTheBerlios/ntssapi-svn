...
<center>
<!-- Header portion  -->
<table class="main_outer_table" cellpadding="0" cellspacing="0" width="779" border="0" >
	<tr>
		<td width="100%">
          ...
          <a href="index.php"><img src="{$image_dir}homepage_icon.gif" border="0" width="18" height="18" alt="" /></a>
			...
			<table width="779" border="0" cellpadding="{$config.cellpadding}"  cellspacing="{$config.cellspacing}"   bgcolor="#FFFFFF">
				<tr>
<!-- Leftside Menu   -->
