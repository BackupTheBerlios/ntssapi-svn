{strip}
<form name="srch01" action="search_popup.php" method="post">
...
<table id="tbl" class="table"  width="95%" border="0" cellpadding="{$config.cellpadding}" cellspacing="{$config.cellspacing}">
	<tbody>
	<form name="frmadvsearch" id="frmadvsearch" method="post" action="searchprofiles_popup.php">
		<tr>
			<td colspan="2">
		...
		<tr>
			...
			<td>
				<select class="select" style="width: 175px; height: 30px;" id="txtcountry" name="txtcountry" onChange="javascript: document.srch01.countrycode.value=document.frmadvsearch.txtcountry.value; document.srch01.submit(); ">
