					...
					<tr>
						<td>
							<table width="100%">
								<tr>
									<td align="left">
										<input type="button" class="formbutton" value="{$lang.my_matches}" onclick="javascript: document.location.href='search_popup.php';">&nbsp;
										<input type="button" value="{$lang.extended_search}" class="formbutton"  onclick="javascript: document.location.href='extsearch_popup.php';">&nbsp;
									</td>
									<td align="right">
										<input type="button" value="{$lang.close_window}" class="formbutton"  onclick="javascript: window.opener.focus(); window.close();">&nbsp;
									</td>
								</tr>
							</table>
						</td>
