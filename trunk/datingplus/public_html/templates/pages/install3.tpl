...
<tr><td colspan=2 class=normal>The osDate installer needs some information about your mail settings, so that form submissions can be correctly processed. If you do not know this information, then please skip this step. osDate will attempt to use the Standard PHP Mail functions by default.</td></tr>

<form action="?step=5" method="post" align="center" name="installInfo">
