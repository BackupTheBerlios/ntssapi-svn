...
$sqlselect = 'msg.id, user.username, user.firstname, user.lastname, msg.senderid, msg.subject, msg.message, msg.flagread, msg.sendtime, msg.flagdelete, msg.recipientid ';
...
if ( $err != 0 ) {
	...
	$t->assign( 'error', $lang['errormsgs'][$err] );
