...
//
// $Id: htmlarea.js,v 1.2 2005/01/21 06:56:46 djmaze Exp $
...
HTMLArea.Config = function () {
	...
	this.pageStyle = 'body { background-color: white; color: black; font-family: arial,helvetica,sans-serif }';
	...
	this.toolbar = [
		[ "fontname", "space",
		  ...
		  "inserthorizontalrule", "createlink", "insertimage", "inserttable"
			...
			[ "copy", "cut", "paste", "space", "undo", "redo", "space", "removeformat", "killword", "separator" ,
